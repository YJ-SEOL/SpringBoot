  ...
  <div class="container mt-5 pt-5">
    ...
    <table class="table">
      ...
      <tr>
        ...
        <th scope="col">FAQ 내용(CONTENT)</th>
        <th scope="col">Edit</th>
      </tr>
      </thead>
      <!--      조회 데이터 생성 부분-->
      <tbody v-for="(faq, index) in faqs"
             :key="index"
      >
      <tr>
        <td>{{ faq.id }}</td>
        ...
        <td>{{ faq.content }}</td>
        <td>
          <a :href="'/edit_faq/' + faq.id" class="btn btn-primary">
            Edit
          </a>
        </td>
      </tr>
